...
const ContactSectionDark = () => {
    return (
        <div className="relative bg-cover bg-black bg-center p-10">
            <div className="max-w-4xl mx-auto flex flex-col md:flex-row items-center justify-between border-2 border-white p-10 rounded-lg">
                ...
                <div className="flex flex-col items-end">
                    <div className="flex space-x-2 mb-2"> {/* Added space between buttons */}
                        <button 
                            ...
                            className="flex items-center bg-blue-500 text-white rounded px-4 py-2 hover:bg-gray-600 transition duration-200"
                        >
